...
const App = () => {
  ...
  return (
    <Router>
      <div
        className={`${themeAccent} ${themeBackground} bg-primary text-main flex justify-center`}
      >
        <div
          className={`min-h-screen w-full max-w-screen-2xl grid grid-cols-1 sm:grid-cols-8 md:grid-cols-11 lg:grid-cols-10 xl:grid-cols-12`}
        >
          <SideBarMenu />
          <Notification />
          <Modal />
