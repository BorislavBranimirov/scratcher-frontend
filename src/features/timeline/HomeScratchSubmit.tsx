      ...
      <div className="min-w-0 grow" data-cy="home-post-scratch">
        ...
        {!isSubmitting && (
          <div className="border-t border-primary pt-3 flex justify-between items-center">
            ...
            <button
              className="bg-accent text-sm rounded-full py-1.5 px-4 font-bold text-accent-inverted transition-colors enabled:hover:bg-accent/80 enabled:active:bg-accent/60 disabled:opacity-75"
